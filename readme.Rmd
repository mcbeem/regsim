...
Let us imagine that we can measure variable $X$ with a reliability of 0.7. According to classical test theory, the observed score $X_{O}$ is composed of a true score component $X_{T}$ plus measurement error component $X_{E}$. 

A key equation in classical test theory is

$Var(X) = Var(T) / [Var(T)+Var(E)]$
